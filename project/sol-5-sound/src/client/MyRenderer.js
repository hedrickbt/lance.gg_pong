    ...
    draw(t, dt) {
        ...
        for (let objId of Object.keys(this.sprites)) {
            if (this.sprites[objId].el) {
                ...
                if ((this.sprites[objId].el.className == 'paddle1') || (this.sprites[objId].el.className == 'paddle2')) {
                    if (this.gameEngine.world.objects[objId].disabled_timestamp == '') {
                        this.sprites[objId].el.style.backgroundColor = 'white';
                    } else {
                        this.sprites[objId].el.style.backgroundColor = 'pink';
                    }
                }
            }
        }
