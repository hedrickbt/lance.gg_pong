...
export default class MyGameEngine extends GameEngine {
	...
	initGame() {
        ...
        this.addObjectToWorld(new Bullet(this, null, { position: new TwoVector(PADDING, 0), playerId: 1 }));
        this.addObjectToWorld(new Bullet(this, null, { position: new TwoVector(WIDTH - PADDING, 0), playerId: 2 }));
	...
	postStepHandleBall() {
        ...
        } else if (this.bullet1.position.x <= 0) {
            // ball hit left wall
            this.bullet2.velocity.set(0,0);
            this.bullet2.position.x = -10;
            this.bullet2.position.y = -10;
